<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="{{ route('articles.index') }}" class="bg-slate-700
             text-sm rounded-md text-white px-3 py-2">Back</a>
           </div>
    </x-slot>
                 ...
                 <form action="{{ route('articles.store') }}" method="post">
                  @csrf
                    <div>
                      ...
                      <div class="my-3">
                        <textarea name="text" placeholder="Content" id="text" cols="30" rows="10"  class="border-gray-300 shadow-sm w-1/2 rounded-lg" value="{{ old('title') }}"></textarea>
                      </div>
